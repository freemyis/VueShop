<template>
  <div>
    <van-tabbar v-model="active" @change="onChange" route>
      <van-tabbar-item replace to="/Persontr/" icon="home-o" name="home">Home</van-tabbar-item>
      <van-tabbar-item to="/Persontr/ShopMessage" icon="search" name="shop" :badge="shopNumber">Shop</van-tabbar-item>
      <van-tabbar-item
      ...
      <van-tabbar-item to="/Persontr/PersonCenter" icon="setting-o" name="user">User</van-tabbar-item>
    </van-tabbar>
  </div>
</template>
